...
from modules.whisperx.audio import N_SAMPLES, SAMPLE_RATE, load_audio, log_mel_spectrogram
from modules.whisperx.schema import SingleSegment, TranscriptionResult, ProgressCallback
from modules.whisperx.vads import Vad, Silero, Pyannote
